...
<div class="form-container">
    <div class="form-header">
        <h3><i class="fas fa-user-plus"></i> Tambah Peminjam Baru</h3>
    </div>
        ...
        <form method="POST" action="{{ route('admin.peminjam.store') }}" enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    placeholder="Contoh: peminjam@email.com" 
                    value="{{ old('email') }}"
                    required
                >
                @error('email')
            ...
            <div class="form-group">
                ...
                >
                    ...
                    @foreach($suratUkur as $surat)
                        <option value="{{ $surat->id }}" {{ old('surat_ukur_id') == $surat->id ? 'selected' : '' }}>
            ...
            <div class="form-group">
                <label>
                    <i class="fas fa-image" style="margin-right: 5px;"></i> Foto Profil (Opsional)
                </label>
